 ...
 **/
public class lotterActivityTest {
...
//        RestClient rc = new RestClient(apiDomain,addLotterService);
        RestClient rc = new RestClient("http://msv-zuul-sit.hupu.io:8769/bigboy-hupubackend-api",addLotterService);
        Map<String,Object> map = new HashMap<>();
        map.put("name","指定中奖"+RandomUtil.getDigits(4));
        map.put("startTime","2021-10-12 10:00:00");
        map.put("endTime","2021-12-25 14:00:00");
